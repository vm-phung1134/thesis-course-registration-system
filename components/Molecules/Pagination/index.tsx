  ...
  return (
    <nav aria-label="Page navigation example">
      <ul className="list-style-none flex">
        ...
        <li>
          <a
            className="relative block rounded bg-transparent font-medium px-3 py-1.5 text-sm text-neutral-600 transition-all duration-300 hover:bg-neutral-100  dark:text-white dark:hover:bg-neutral-700 dark:hover:text-white"
            href="#!"
          >
            {currentPage}
          </a>
