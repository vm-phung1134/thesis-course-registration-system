      ...
      <ul className="menu gap-3">
        <li>
          ...
          >
            ...
            <span className="mx-2 text-[15px] font-medium">Dashboard</span>
          </Link>
        </li>
        <li>
          <Link
        ...
        <li>
          <Link
            className="rounded-none hover:bg-green-700 hover:text-white"
            href="/admin/schedule-time-defense"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
        ...
        <li>
          <details open>
            <summary className="rounded-none hover:bg-green-700 hover:text-white">
              ...
              <span className="mx-2 text-[15px] font-medium">Alumnus</span>
            </summary>
