...
import { FilterScheduledForm, SearchForm } from "@/components/Molecules";
...
import { PrivateCommentForm } from "@/components/Molecules/PrivateCommentForm";
      ...
      <div className="justify-between w-full">
        ...
        <div className="flex gap-10">
          <div className="flex items-center">
            ...
            <Link href={"/tasks/critical-tasks"}>
              <button className="btn btn-ghost btn-circle">
                <p className="indicator text-lg p-1 dark:bg-gray-200 dark:rounded-full">
                  <Image
                    width={18}
                    height={18}
                    alt="icon-archire"
          ...
          <div tabIndex={0} className="flex gap-3 items-center cursor-pointer">
            <div className="flex flex-col text-[15px] font-normal items-end">
              <p className="font-medium text-sm capitalize">
                {convertToUnaccentedString(currentUser.name || user.name)}
              </p>
              <p className="text-green-800 text-sm capitalize dark:text-green-500">
                Pov: {user.role || currentUser?.role}
              </p>
            </div>
              ...
              <div className="avatar object-center">
                <div className="rounded-full">
                  <Image
                    ...
                    height={100}
                    alt="avatar"
                    src={user.photoSrc || currentUser?.photoSrc}
                  />
                </div>
              </div>
            </div>
